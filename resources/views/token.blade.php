...
<div class="container">    
      ...
      <div class="col-sm-6 col-md-4">
        <div class="token-wrapper">
          <div id="token-link-redirect" class="token-header">
            <p class="token-title">Link Redirect</p>
            <div class="token-price-wrapper">
              <p class="token-price">FREE</p>
              <p class="per-element">one time action</p>
            </div>
          </div>
          <div class="token-body">
    ...
    <!-- Token Domain Assign -->   
      <div class="col-sm-6 col-md-4">
        <div class="token-wrapper">
          <div id="token-domain-assign" class="token-header">
            <p class="token-title">Domain Assign</p>
            <div class="token-price-wrapper">
              <p class="token-price">FREE</p>
              <p class="per-element">one time action</p>
            </div>
